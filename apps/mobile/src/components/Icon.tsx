...
const ICONS: Record<IconName, Draw> = {
  ...
  github: (c, sw) => (
    <Path
      d="M12 2.6c-5.2 0-9.4 4.2-9.4 9.4 0 4.2 2.7 7.7 6.4 9 .5.1.6-.2.6-.4v-1.5c-2.6.6-3.2-1.1-3.2-1.1-.4-1.1-1-1.4-1-1.4-.9-.6.1-.6.1-.6 1 .1 1.5 1 1.5 1 .9 1.5 2.3 1.1 2.9.8.1-.6.3-1.1.6-1.3-2.1-.2-4.3-1-4.3-4.6 0-1 .4-1.9 1-2.5-.1-.2-.4-1.2.1-2.5 0 0 .8-.3 2.6 1a9 9 0 0 1 4.8 0c1.8-1.3 2.6-1 2.6-1 .5 1.3.2 2.3.1 2.5.6.7 1 1.5 1 2.5 0 3.5-2.2 4.4-4.3 4.6.4.3.7.9.7 1.8v2.6c0 .2.2.5.7.4 3.7-1.2 6.4-4.8 6.4-9 0-5.2-4.2-9.4-9.4-9.4Z"
      stroke={c}
      strokeWidth={sw}
    />
  ),
